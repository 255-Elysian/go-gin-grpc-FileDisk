...
const (
	...
	UserService_UserChangePassword_FullMethodName = "/UserService/UserChangePassword"
...
type UserServiceClient interface {
	...
	UserChangePassword(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResponse, error)
...
func (c *userServiceClient) UserChangePassword(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserCommonResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserCommonResponse)
...
type UserServiceServer interface {
	...
	UserChangePassword(context.Context, *UserRequest) (*UserCommonResponse, error)
...
func (UnimplementedUserServiceServer) UserChangePassword(context.Context, *UserRequest) (*UserCommonResponse, error) {
...
func _UserService_UserChangePassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).UserChangePassword(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
