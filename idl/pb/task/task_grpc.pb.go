...
const (
	...
	TaskService_TaskShowOne_FullMethodName = "/TaskService/TaskShowOne"
)
...
type TaskServiceClient interface {
	...
	TaskShowOne(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TasksDetailResponse, error)
}
...
func (c *taskServiceClient) TaskShowOne(ctx context.Context, in *TaskRequest, opts ...grpc.CallOption) (*TasksDetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TasksDetailResponse)
	err := c.cc.Invoke(ctx, TaskService_TaskShowOne_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TaskServiceServer interface {
	...
	TaskShowOne(context.Context, *TaskRequest) (*TasksDetailResponse, error)
...
func (UnimplementedTaskServiceServer) TaskShowOne(context.Context, *TaskRequest) (*TasksDetailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TaskShowOne not implemented")
}
...
func _TaskService_TaskShowOne_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TaskRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TaskServiceServer).TaskShowOne(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TaskService_TaskShowOne_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TaskServiceServer).TaskShowOne(ctx, req.(*TaskRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TaskService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TaskShowOne",
			Handler:    _TaskService_TaskShowOne_Handler,
		},
	},
